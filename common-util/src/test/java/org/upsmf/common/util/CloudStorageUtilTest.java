...
public class CloudStorageUtilTest {
  ...
  public void testGetStorageTypeSuccess() {
    CloudStorageUtil.CloudStorageType storageType = CloudStorageUtil.CloudStorageType.getByName("azure");
    assertTrue(CloudStorageUtil.CloudStorageType.AZURE.equals(storageType));
  }

  @Test(expected = ProjectCommonException.class)
  public void testGetStorageTypeFailureWithWrongType() {
    CloudStorageUtil.CloudStorageType.getByName("wrongstorage");
  }
  ...
  public void testUploadSuccess() {
    String result =
        CloudStorageUtil.upload(CloudStorageUtil.CloudStorageType.AZURE, "container", "key", "/file/path");
  ...
  public void testGetSignedUrlSuccess() {
    String signedUrl = CloudStorageUtil.getSignedUrl(CloudStorageUtil.CloudStorageType.AZURE, "container", "key");
