...
public class ProjectUtilTest extends BaseHttpTest {
  ...
  public void testMigrateActionAcceptValueFailure() {
    assertNotEquals("ok", ProjectUtil.MigrateAction.ACCEPT.getValue());
  }

  @Test
  public void testMigrateActionRejectValueFailure() {
    assertNotEquals("no", ProjectUtil.MigrateAction.REJECT.getValue());
  }

  @Test
  public void testMigrateActionAcceptValueSuccess() {
    assertEquals("accept", ProjectUtil.MigrateAction.ACCEPT.getValue());
  }

  @Test
  public void testMigrateActionRejectValueSuccess() {
    assertEquals("reject", ProjectUtil.MigrateAction.REJECT.getValue());
  }
